...
function renderExecutive(){
  ...
  const table=$('#executiveSummaryBody'); if(table)table.innerHTML=`<tr><td>2026</td><td class="text-right">${money(credito)}</td><td class="text-right">${money(empenhado)}</td><td class="text-right">${money(total)}</td><td class="text-center">${pct(credito,total)}</td></tr>`;
